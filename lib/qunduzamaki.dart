...
class Qunduzamaki extends StatefulWidget {
  const Qunduzamaki({super.key});

  @override
  State<Qunduzamaki> createState() => _YoutubeApp1State();
}

class _YoutubeApp1State extends State<Qunduzamaki> {
  ...
  final List<String> _images = [
    'https://img.youtube.com/vi/Zzw6zzrudVY/0.jpg', //1
    'https://img.youtube.com/vi/1xE_KicUnIM/0.jpg', //2
  ];

  // Har bir video uchun alohida text
  final List<String> _titles = [
    'Qunduz Amaki 6-10 Qism',
    'Qunduz Amaki 11-15 Qism',
  ];
  ...
  void initState() {
    super.initState(); HistoryHelper.addToHistory(
      title: "Qunduz Amaki",
      imageUrl: 'https://img.youtube.com/vi/Zzw6zzrudVY/0.jpg',
    );
    ...
    return YoutubePlayerBuilder(
      ...
      builder: (context, player) => Scaffold(
        appBar: AppBar(
          ...
          title: const Text('Qunduz Amaki Qissalari'),

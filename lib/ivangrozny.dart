...
class Ivangrozny extends StatefulWidget {
  const Ivangrozny({super.key});

  @override
  State<Ivangrozny> createState() => _YoutubeApp1State();
}

class _YoutubeApp1State extends State<Ivangrozny> {
  ...
  final List<String> _images = [
    'https://img.youtube.com/vi/I4zxo3Kp21I/0.jpg', //1
  ];

  // Har bir video uchun alohida text
  final List<String> _titles = ['Ivan Vaseylivich'];

  @override
  void initState() {
    super.initState(); HistoryHelper.addToHistory(
      title: "Ivan Vaseylivich",
      imageUrl: 'https://img.youtube.com/vi/I4zxo3Kp21I/0.jpg',
    );
    ...
    return YoutubePlayerBuilder(
      ...
      builder: (context, player) => Scaffold(
        appBar: AppBar(
          ...
          title: const Text('Ivan Vaseylivich'),

...
class Ichkuyov extends StatefulWidget {
  const Ichkuyov({super.key});

  @override
  State<Ichkuyov> createState() => _YoutubeApp1State();
}

class _YoutubeApp1State extends State<Ichkuyov> {
  ...
  final List<String> _images = [
    'https://img.youtube.com/vi/9F16cxwZSgQ/0.jpg', //1
  ];

  // Har bir video uchun alohida text
  final List<String> _titles = ['Ichkuyov'];
  ...
  void initState() {
    ...
    HistoryHelper.addToHistory(
      title: "ichkuyov",
      imageUrl: 'https://img.youtube.com/vi/9F16cxwZSgQ/0.jpg',
    );

...
class Nussa extends StatefulWidget {
  const Nussa({super.key});

  @override
  State<Nussa> createState() => _YoutubeApp1State();
}

class _YoutubeApp1State extends State<Nussa> {
  ...
  final List<String> _images = [
    'https://img.youtube.com/vi/zYGHi6QJY4g/0.jpg', //1
    'https://img.youtube.com/vi/MYPsAh_mVuE/0.jpg', //1
  ];

  // Har bir video uchun alohida text
  final List<String> _titles = ["Nussa Va Rara 1-fasl", "Nussa Va Rara 2-fasl"];

  @override
  void initState() {
    super.initState(); HistoryHelper.addToHistory(
      title: "Nussa va Rara",
      imageUrl: 'https://img.youtube.com/vi/zYGHi6QJY4g/0.jpg',
    );
    ...
    return YoutubePlayerBuilder(
      ...
      builder: (context, player) => Scaffold(
        appBar: AppBar(
          ...
          title: const Text("Nussa va Rara"),

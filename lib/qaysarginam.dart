...
class Qaysarginam extends StatefulWidget {
  const Qaysarginam({super.key});

  @override
  State<Qaysarginam> createState() => _YoutubeApp1State();
}

class _YoutubeApp1State extends State<Qaysarginam> {
  ...
  final List<String> _images = [
    'https://img.youtube.com/vi/fNxF0okFGNI/0.jpg', //1
    'https://img.youtube.com/vi/8hrUzzOl2uU/0.jpg', //2
  ];

  // Har bir video uchun alohida text
  final List<String> _titles = ["Qaysarginam", "Qaysarginam 2"];

  @override
  void initState() {
    super.initState(); HistoryHelper.addToHistory(
      title: "Qaysarginam",
      imageUrl: 'https://img.youtube.com/vi/fNxF0okFGNI/0.jpg',
    );

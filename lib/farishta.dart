...
class Farishta extends StatefulWidget {
  ...
  @override
  State<Farishta> createState() => _YoutubeApp1State();
}

class _YoutubeApp1State extends State<Farishta> {
  ...
  final List<String> _images = [
    'https://img.youtube.com/vi/CT7YhRBOweA/0.jpg', //1
    'https://img.youtube.com/vi/cI_WyQygsG4/0.jpg', //1
  ];
    ...
    return YoutubePlayerBuilder(
      ...
      builder: (context, player) => Scaffold(
        appBar: AppBar(
          ...
          title: const Text('Sevgi Farishtasi'),

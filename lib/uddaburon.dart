...
class Uddaburon extends StatefulWidget {
  ...
  @override
  State<Uddaburon> createState() => _YoutubeApp1State();
}

class _YoutubeApp1State extends State<Uddaburon> {
  ...
  final List<String> _images = [
    'https://img.youtube.com/vi/OIA0Tdn_qeA/0.jpg', //1
  ];

  // Har bir video uchun alohida text
  final List<String> _titles = ['Uddaburon Bolalar'];
    ...
    return YoutubePlayerBuilder(
      ...
      builder: (context, player) => Scaffold(
        appBar: AppBar(
          ...
          title: const Text('Uddaburon bolalar'),

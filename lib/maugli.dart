...
class Maugli extends StatefulWidget {
  ...
  @override
  State<Maugli> createState() => _YoutubeApp1State();
}

class _YoutubeApp1State extends State<Maugli> {
  ...
  final List<String> _images = [
    'https://img.youtube.com/vi/gUs-7mWk3nk/0.jpg', //1
  ];

  // Har bir video uchun alohida text
  final List<String> _titles = ['Maugli '];
    ...
    return YoutubePlayerBuilder(
      ...
      builder: (context, player) => Scaffold(
        appBar: AppBar(
          ...
          title: const Text('Maugli: Yovvoyi Sayyora'),

...
class Uchargilam extends StatefulWidget {
  const Uchargilam({super.key});

  @override
  State<Uchargilam> createState() => _YoutubeApp1State();
}

class _YoutubeApp1State extends State<Uchargilam> {
  ...
  final List<String> _images = [
    'https://img.youtube.com/vi/fB8HNFfzIW4/0.jpg', //1
  ];

  // Har bir video uchun alohida text
  final List<String> _titles = ['Uchar Gilam'];

  @override
  void initState() {
    super.initState(); HistoryHelper.addToHistory(
      title: "Uchar Gilam",
      imageUrl: 'https://img.youtube.com/vi/fB8HNFfzIW4/0.jpg',
    );

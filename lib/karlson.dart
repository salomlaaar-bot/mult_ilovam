...
class Karlson extends StatefulWidget {
  ...
  @override
  State<Karlson> createState() => _YoutubeApp1State();
}

class _YoutubeApp1State extends State<Karlson> {
  ...
  final List<String> _images = [
    'https://img.youtube.com/vi/B61qAgCH6RI/0.jpg', //1
  ];

  // Har bir video uchun alohida text
  final List<String> _titles = ['Yana Osha, Karlson'];

...
class Nupogadi extends StatefulWidget {
  const Nupogadi({super.key});

  @override
  State<Nupogadi> createState() => _YoutubeApp1State();
}

class _YoutubeApp1State extends State<Nupogadi> {
  ...
  final List<String> _images = [
    'https://img.youtube.com/vi/uJ2dmylY1Mw/0.jpg', //1
  ];

  // Har bir video uchun alohida text
  final List<String> _titles = ['Nu pogadi 125-min'];

  @override
  void initState() {
    super.initState(); HistoryHelper.addToHistory(
      title: "Nu Pogadi 125-min",
      imageUrl: 'https://img.youtube.com/vi/uJ2dmylY1Mw/0.jpg',
    );

...
class Novda extends StatefulWidget {
  ...
  @override
  State<Novda> createState() => _YoutubeApp1State();
}

class _YoutubeApp1State extends State<Novda> {
  ...
  final List<String> _images = [
    'https://img.youtube.com/vi/FVSAtbNsJzI/0.jpg', //1
  ];

  // Har bir video uchun alohida text
  final List<String> _titles = ["Novda"];

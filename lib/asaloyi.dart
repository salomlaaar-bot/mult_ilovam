...
class Asaloyi extends StatefulWidget {
  const Asaloyi({super.key});

  @override
  State<Asaloyi> createState() => _YoutubeApp1State();
}

class _YoutubeApp1State extends State<Asaloyi> {
  ...
  final List<String> _images = [
    'https://img.youtube.com/vi/xBDLqtyi97Y/0.jpg', //1
  ];

  // Har bir video uchun alohida text
  final List<String> _titles = ["Asal Oyi"];
  ...
  void initState() {
    super.initState();
     HistoryHelper.addToHistory(
      title: 'Asal Oyi',
      imageUrl: 'https://img.youtube.com/vi/xBDLqtyi97Y/0.jpg',
    );

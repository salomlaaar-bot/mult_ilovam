...
class Avtosarguzash extends StatefulWidget {
  ...
  @override
  State<Avtosarguzash> createState() => _YoutubeApp1State();
}

class _YoutubeApp1State extends State<Avtosarguzash> {
  ...
  final List<String> _images = [
    'https://img.youtube.com/vi/T_HcLB0nmVY/0.jpg', //1
  ];

  // Har bir video uchun alohida text
  final List<String> _titles = ['Avtosarguzashtlar'];
    ...
    return YoutubePlayerBuilder(
      ...
      builder: (context, player) => Scaffold(
        appBar: AppBar(
          ...
          title: const Text('Avtosarguzashtlar'),

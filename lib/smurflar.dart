...
class Smurflar extends StatefulWidget {
  const Smurflar({super.key});

  @override
  State<Smurflar> createState() => _YoutubeApp1State();
}

class _YoutubeApp1State extends State<Smurflar> {
  ...
  final List<String> _images = [
    'https://img.youtube.com/vi/5Y-NzcLuRIQ/0.jpg', //1
  ];

  // Har bir video uchun alohida text
  final List<String> _titles = ['Smurflar 90-min'];

  @override
  void initState() {
    super.initState(); HistoryHelper.addToHistory(
      title: "Smurflar",
      imageUrl: 'https://img.youtube.com/vi/5Y-NzcLuRIQ/0.jpg',
    );

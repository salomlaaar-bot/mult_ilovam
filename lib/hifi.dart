...
class Hifi extends StatefulWidget {
  const Hifi({super.key});

  @override
  State<Hifi> createState() => _YoutubeApp1State();
}

class _YoutubeApp1State extends State<Hifi> {
  ...
  final List<String> _images = [
    'https://img.youtube.com/vi/klIwwJBxDx4/0.jpg', //1
  ];

  // Har bir video uchun alohida text
  final List<String> _titles = ['Hi-fi Bolakay'];
  ...
  void initState() {
    super.initState();
     HistoryHelper.addToHistory(
      title: "Hi-fi Bolakay",
      imageUrl: 'https://img.youtube.com/vi/klIwwJBxDx4/0.jpg',
    );
    ...
    return YoutubePlayerBuilder(
      ...
      builder: (context, player) => Scaffold(
        appBar: AppBar(
          ...
          title: const Text('Hi-fi Bolakay'),

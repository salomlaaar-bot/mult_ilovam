...
class Sehrliqalpoqcha extends StatefulWidget {
  const Sehrliqalpoqcha({super.key});

  @override
  State<Sehrliqalpoqcha> createState() => _YoutubeApp1State();
}

class _YoutubeApp1State extends State<Sehrliqalpoqcha> {
  ...
  final List<String> _images = [
    'https://img.youtube.com/vi/nWQS38wkEzE/0.jpg', //1
  ...
  void initState() {
    super.initState(); HistoryHelper.addToHistory(
      ...
      imageUrl: 'https://img.youtube.com/vi/nWQS38wkEzE/0.jpg',
    );
    ...
    return YoutubePlayerBuilder(
      ...
      builder: (context, player) => Scaffold(
        appBar: AppBar(
          ...
          title: const Text('Sehrli Qalpoqcha'),

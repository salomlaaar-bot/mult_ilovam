...
class Qarsildoq extends StatefulWidget {
  ...
  @override
  State<Qarsildoq> createState() => _YoutubeApp1State();
}

class _YoutubeApp1State extends State<Qarsildoq> {
  ...
  final List<String> _images = [
    'https://img.youtube.com/vi/jKkkykmf-70/0.jpg', //1
  ];

  // Har bir video uchun alohida text
  final List<String> _titles = ['Qarsildoq '];

...
class Buba extends StatefulWidget {
  const Buba({super.key});

  @override
  State<Buba> createState() => _YoutubeApp1State();
}

class _YoutubeApp1State extends State<Buba> {
  ...
  final List<String> _images = [
    'https://img.youtube.com/vi/GNfld6kBA6k/0.jpg', //1
  ];

  // Har bir video uchun alohida text
  final List<String> _titles = ['Buba 36-Qism'];
  ...
  void initState() {
    super.initState();
     HistoryHelper.addToHistory(
      title: 'Buba 36-Qism',
      imageUrl: 'https://img.youtube.com/vi/GNfld6kBA6k/0.jpg',
    );

...
class Quloqpiter extends StatefulWidget {
  ...
  @override
  State<Quloqpiter> createState() => _YoutubeApp1State();
}

class _YoutubeApp1State extends State<Quloqpiter> {
  ...
  final List<String> _images = [
    'https://img.youtube.com/vi/IGz5t3PYeYs/0.jpg', //1
  ];

  // Har bir video uchun alohida text
  final List<String> _titles = ['Uzunquloq Piter 1'];
    ...
    return YoutubePlayerBuilder(
      ...
      builder: (context, player) => Scaffold(
        appBar: AppBar(
          ...
          title: const Text('Uzunquloq Piter '),

...
class Oshiqlar extends StatefulWidget {
  const Oshiqlar({super.key});

  @override
  State<Oshiqlar> createState() => _YoutubeApp1State();
}

class _YoutubeApp1State extends State<Oshiqlar> {
  ...
  final List<String> _images = [
    'https://img.youtube.com/vi/oeKcX6Y2xCA/0.jpg', //1
  ];

  // Har bir video uchun alohida text
  final List<String> _titles = ['Oshiqlar'];

  @override
  void initState() {
    super.initState(); HistoryHelper.addToHistory(
      title: "Oshiqlar",
      imageUrl: 'https://img.youtube.com/vi/oeKcX6Y2xCA/0.jpg',
    );

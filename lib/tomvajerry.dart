...
class Tomvajerry extends StatefulWidget {
  const Tomvajerry({super.key});

  @override
  State<Tomvajerry> createState() => _YoutubeApp1State();
}

class _YoutubeApp1State extends State<Tomvajerry> {
  ...
  final List<String> _images = [
    'https://img.youtube.com/vi/PdYuDMdED1E/0.jpg', //1
  ];

  // Har bir video uchun alohida text
  final List<String> _titles = ['Tom va jerry 60-min'];

  @override
  void initState() {
    super.initState(); HistoryHelper.addToHistory(
      title: "Tom va Jerry",
      imageUrl: 'https://img.youtube.com/vi/PdYuDMdED1E/0.jpg',
    );

...
class Nikolya extends StatefulWidget {
  const Nikolya({super.key});

  @override
  State<Nikolya> createState() => _YoutubeApp1State();
}

class _YoutubeApp1State extends State<Nikolya> {
  ...
  final List<String> _images = [
    'https://img.youtube.com/vi/uqNFAiJxYV8/0.jpg', //1
  ];

  // Har bir video uchun alohida text
  final List<String> _titles = ['Kichkina Nikolya 75-min'];

  @override
  void initState() {
    super.initState(); HistoryHelper.addToHistory(
      title: "Kichkina Nikolya 75-min",
      imageUrl: 'https://img.youtube.com/vi/uqNFAiJxYV8/0.jpg',
    );
    ...
    return YoutubePlayerBuilder(
      ...
      builder: (context, player) => Scaffold(
        appBar: AppBar(
          ...
          title: const Text('Kichkina Nikolya'),

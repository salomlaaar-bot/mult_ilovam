...
class Olingquda extends StatefulWidget {
  const Olingquda({super.key});

  @override
  State<Olingquda> createState() => _YoutubeApp1State();
}

class _YoutubeApp1State extends State<Olingquda> {
  ...
  final List<String> _images = [
    'https://img.youtube.com/vi/4T2pE5ZPAf4/0.jpg', //1
  ];

  // Har bir video uchun alohida text
  final List<String> _titles = ['oling quda bering quda'];

  @override
  void initState() {
    super.initState();
    HistoryHelper.addToHistory(
      title: "Oling Quda Bering Quda",
      imageUrl:
    ...
    return YoutubePlayerBuilder(
      ...
      builder: (context, player) => Scaffold(
        appBar: AppBar(
          ...
          title: const Text('Oling Quda Bering Quda'),

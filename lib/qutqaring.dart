...
class Qutqaring extends StatefulWidget {
  const Qutqaring({super.key});

  @override
  State<Qutqaring> createState() => _YoutubeApp1State();
}

class _YoutubeApp1State extends State<Qutqaring> {
  ...
  final List<String> _images = [
    'https://img.youtube.com/vi/Slh8aQp5XmI/0.jpg', //1
  ];

  // Har bir video uchun alohida text
  final List<String> _titles = ['Qutqaring sevib qoldim'];

  @override
  void initState() {
    super.initState();
    HistoryHelper.addToHistory(
      title: "Qutqaring sevib qoldim",
      imageUrl: 'https://img.youtube.com/vi/Slh8aQp5XmI/0.jpg',
    );
    ...
    return YoutubePlayerBuilder(
      ...
      builder: (context, player) => Scaffold(
        appBar: AppBar(
          ...
          title: const Text('Qutqaring sevib qoldim'),

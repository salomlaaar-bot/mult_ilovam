...
class EndiDadamBoydoq extends StatefulWidget {
  const EndiDadamBoydoq({super.key});

  @override
  State<EndiDadamBoydoq> createState() => _YoutubeApp1State();
}

class _YoutubeApp1State extends State<EndiDadamBoydoq> {
  ...
  final List<String> _images = [
    'https://img.youtube.com/vi/y3x6alUefR8/0.jpg', //1
    'https://img.youtube.com/vi/YWbGKcyajks/0.jpg', //1
  ];

  // Har bir video uchun alohida text
  final List<String> _titles = ['Endi Dadam Bo\'ydoq', 'Endi Akam Bo\'ydoq '];

  @override
  void initState() {
    super.initState();
    HistoryHelper.addToHistory(
      title: "Endi Dadam Bo'ydoq",
      imageUrl: 'https://img.youtube.com/vi/y3x6alUefR8/0.jpg', //1
    );
    ...
    return YoutubePlayerBuilder(
      ...
      builder: (context, player) => Scaffold(
        appBar: AppBar(
          ...
          title: const Text("Endi Dadam Bo'ydoq"),

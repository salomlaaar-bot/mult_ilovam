...
class Doppipomidor extends StatefulWidget {
  const Doppipomidor({super.key});

  @override
  State<Doppipomidor> createState() => _YoutubeApp1State();
}

class _YoutubeApp1State extends State<Doppipomidor> {
  ...
  final List<String> _images = [
    'https://img.youtube.com/vi/tozETEL9FjM/0.jpg', //1

  ];

  // Har bir video uchun alohida text
  final List<String> _titles = [
    'Doppi Pomidor 45-min',
  ...
  void initState() {
    super.initState(); HistoryHelper.addToHistory(
      title: "Do'ppi Pomidor",
      imageUrl: 'https://img.youtube.com/vi/tozETEL9FjM/0.jpg',
    );
    ...
    return YoutubePlayerBuilder(
      ...
      builder: (context, player) => Scaffold(
        appBar: AppBar(
          ...
          title: const Text("Do'ppi Pomidor"),

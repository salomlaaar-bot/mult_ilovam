...
class Cr7andmessi10 extends StatefulWidget {
  ...
  @override
  State<Cr7andmessi10> createState() => _YoutubeApp1State();
}

class _YoutubeApp1State extends State<Cr7andmessi10> {
  ...
  final List<String> _images = [
    'https://img.youtube.com/vi/Nm4CjNiOu1M/0.jpg', //1
  ];

  // Har bir video uchun alohida text
  final List<String> _titles = ['Cristiano & Leo'];
    ...
    return YoutubePlayerBuilder(
      ...
      builder: (context, player) => Scaffold(
        appBar: AppBar(
          ...
          title: const Text('Cristiano Va Leo Hayoti'),

...
class Sariqdev extends StatefulWidget {
  ...
  @override
  State<Sariqdev> createState() => _YoutubeApp1State();
}

class _YoutubeApp1State extends State<Sariqdev> {
  ...
  final List<String> _images = [
    'https://img.youtube.com/vi/9q1BH7RvcOs/0.jpg', //1
    ...
    return YoutubePlayerBuilder(
      ...
      builder: (context, player) => Scaffold(
        appBar: AppBar(
          ...
          title: const Text('Sariq devni minib'),

...
class Uylanish extends StatefulWidget {
  ...
  @override
  State<Uylanish> createState() => _YoutubeApp1State();
}

class _YoutubeApp1State extends State<Uylanish> {
  ...
  final List<String> _images = [
    'https://img.youtube.com/vi/-vKa-rLxhr4/0.jpg', //1
  ];

  // Har bir video uchun alohida text
  final List<String> _titles = ["Uylanish"];

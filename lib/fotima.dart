...
class Fotima extends StatefulWidget {
  const Fotima({super.key});

  @override
  State<Fotima> createState() => _YoutubeApp1State();
}

class _YoutubeApp1State extends State<Fotima> {
  ...
  final List<String> _images = [
    'https://img.youtube.com/vi/PyuRPhQItME/0.jpg', //1
  ];

  // Har bir video uchun alohida text
  final List<String> _titles = ['Fotima va Zuhra'];
  ...
  void initState() {
    ...
    HistoryHelper.addToHistory(
      ...
      imageUrl: 'https://img.youtube.com/vi/PyuRPhQItME/0.jpg', //1
    );
    ...
    return YoutubePlayerBuilder(
      ...
      builder: (context, player) => Scaffold(
        appBar: AppBar(
          ...
          title: const Text('Fotima va Zuhra'),

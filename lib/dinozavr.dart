...
class Dinozavr extends StatefulWidget {
  ...
  @override
  State<Dinozavr> createState() => _YoutubeApp1State();
}

class _YoutubeApp1State extends State<Dinozavr> {
  ...
  final List<String> _images = [
    'https://img.youtube.com/vi/3aHReuJibeg/0.jpg', //1
  ];

  // Har bir video uchun alohida text
  final List<String> _titles = ['Ona Zavr '];

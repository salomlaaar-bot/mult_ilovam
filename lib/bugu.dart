...
class Bugu extends StatefulWidget {
  ...
  @override
  State<Bugu> createState() => _YoutubeApp1State();
}

class _YoutubeApp1State extends State<Bugu> {
  ...
  final List<String> _titles = ["Bug'uning Parvozi"];
    ...
    return YoutubePlayerBuilder(
      ...
      builder: (context, player) => Scaffold(
        appBar: AppBar(
          ...
          title: const Text("Bug'uning Parvozi"),

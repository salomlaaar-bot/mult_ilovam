...
class Ballerina extends StatefulWidget {
  ...
  @override
  State<Ballerina> createState() => _YoutubeApp1State();
}

class _YoutubeApp1State extends State<Ballerina> {
  ...
  final List<String> _images = [
    'https://img.youtube.com/vi/u0Z36lHoHGQ/0.jpg', //1
  ];

  // Har bir video uchun alohida text
  final List<String> _titles = ["Ballerina"];

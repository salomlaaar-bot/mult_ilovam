...
class Uchbaxodir extends StatefulWidget {
  const Uchbaxodir({super.key});

  @override
  State<Uchbaxodir> createState() => _YoutubeApp1State();
}

class _YoutubeApp1State extends State<Uchbaxodir> {
  ...
  final List<String> _images = [
    'https://img.youtube.com/vi/Owtxg4WW4-s/0.jpg', //1
    'https://img.youtube.com/vi/4LP9FgUZDD4/0.jpg'
  ];

  // Har bir video uchun alohida text
  final List<String> _titles = [
    "Uch bahodir -'Ilya Muromets'",
    "Uch bahodir -'Alyosha Popovich'",
  ];
  ...
  void initState() {
    super.initState(); HistoryHelper.addToHistory(
      title: "Uch Bahodir",
      imageUrl: 'https://img.youtube.com/vi/Owtxg4WW4-s/0.jpg',
    );
